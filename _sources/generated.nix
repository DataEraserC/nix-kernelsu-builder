...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  kernelsu-gki-stable = {
    ...
    version = "f65aaff4e39445b504f980db509bbbc680c327d0";
    src = fetchgit {
      url = "https://github.com/tiann/KernelSU.git";
      rev = "f65aaff4e39445b504f980db509bbbc680c327d0";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-7mDEpq4a3M6EfcT/vcMLJ7l3Bm+hg2scVwAb1Ok6QfI=";
    };
    date = "2024-09-29";
  };
  kernelsu-stable = {
  ...
  linux-moto-pstar-lineageos-21 = {
    ...
    version = "9a0acfb6d0411f2c86197d76a8c84eda7701f01f";
    src = fetchFromGitHub {
      owner = "LineageOS";
      repo = "android_kernel_motorola_sm8250";
      rev = "9a0acfb6d0411f2c86197d76a8c84eda7701f01f";
      fetchSubmodules = false;
      sha256 = "sha256-iH9SWSX4LTF95exMc/ACkuikwseaGC2o1gsYNCSasho=";
    };
    date = "2024-09-14";
  };
  ...
  linux-oneplus-8t-blu-spark = {
    ...
    version = "3cd6eae48b9d0362fd3e44e6aea9710aceda818e";
    src = fetchFromGitHub {
      owner = "engstk";
      repo = "op8";
      rev = "3cd6eae48b9d0362fd3e44e6aea9710aceda818e";
      fetchSubmodules = false;
      sha256 = "sha256-yn/xLEVCTgqsYBayg/OUpfZls8urCJ/HLOwBzlXprNA=";
    };
    date = "2024-08-21";
  };
}
