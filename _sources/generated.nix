...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  kernelsu-gki-stable = {
    ...
    version = "ac20b76eaf812dd8b71c76a04878f8a4778292aa";
    src = fetchgit {
      url = "https://github.com/tiann/KernelSU.git";
      rev = "ac20b76eaf812dd8b71c76a04878f8a4778292aa";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-WcMC0YzfVRyg3Df8YFgdgc7xdjV7COEg0mVuzflU+vA=";
    };
    date = "2024-09-14";
  };
  kernelsu-stable = {
  ...
  linux-moto-pstar-lineageos-21 = {
    ...
    version = "bea41e502f15bb8823d9b1a977fbae1a45fedd9a";
    src = fetchFromGitHub {
      owner = "LineageOS";
      repo = "android_kernel_motorola_sm8250";
      rev = "bea41e502f15bb8823d9b1a977fbae1a45fedd9a";
      fetchSubmodules = false;
      sha256 = "sha256-IKETJT3Acpbl7ihlYhvPJ4lzh1MqWCMKrVKe/iEAn9E=";
    };
    date = "2024-09-06";
  };
